...
public class WithdrawMoneyDetailsDialog {
	...
	public WithdrawMoneyDetailsDialog(Context context) {
		...
		@SuppressLint("InflateParams") final View customView = LayoutInflater.from(context).inflate(R.layout.layout_dialog_withdraw_money_details, null, false);
	...
	public void setBillTitleInfo(CharSequence billValue) {
		billTitleTextView.setText(billValue);
	}
