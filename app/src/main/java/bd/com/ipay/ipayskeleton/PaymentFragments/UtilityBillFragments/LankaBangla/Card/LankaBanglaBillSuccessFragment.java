...
public class LankaBanglaBillSuccessFragment extends IPayBillPayTransactionSuccessFragment implements HttpResponseListener {
	...
	public void onCreate(@Nullable Bundle savedInstanceState) {
		...
		if (getArguments() != null) {
			...
			amountType = getArguments().getString(LankaBanglaBillConfirmationFragment.AMOUNT_TYPE_KEY, Constants.OTHER);
	...
	protected void performContinueAction() {
		showSaveInfoDialogue(cardNumber);
	}
	...
	private void showSaveInfoDialogue(final String subscribeId) {
		...
		saveBillDialog.setAccountInfo(subscribeId, getString(R.string.card_number));
	...
	protected void saveAndSchedule(String shortname, boolean isSchedule, String date) {
		...
		if (linkThreeBillPayTask == null) {
			...
			billParamList.add(new BillParam(getString(R.string.card_number), "cardNumber", cardNumber, "String"));
			billParamList.add(new BillParam("Amount", "amount", String.valueOf(billAmount), "Number"));
			billParamList.add(new BillParam("Amount Type", "amountType", amountType, "String"));
			...
			savedBill.setProviderCode(cardType);
