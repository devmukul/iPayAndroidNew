...
public class COLBDBillSuccessFragment extends IPayBillPayTransactionSuccessFragment implements HttpResponseListener {
	...
	public void onCreate(@Nullable Bundle savedInstanceState) {
		...
		if (getArguments() != null) {
			billAmount = (Number) getArguments().getSerializable(COLBDBillConfirmationFragment.BILL_AMOUNT_KEY);
	...
	protected void setupViewProperties() {
		...
		hideUserName();
		hideSaveButton();
		setReceiverImage(R.drawable.colbd);
	}
