...
public class AkashSubscriberIdInputFragment extends IPayAbstractUserIdInputFragment implements HttpResponseListener {
    ...
    protected void setupViewProperties() {
        setTitle("Akash DTH");
        setMerchantIconImage(R.drawable.akash);
        setInputMessage(getString(R.string.akash_subscriber_id_input_message));
    ...
    protected void performContinueAction() {
        ...
        bundle.putString(AkashBillAmountInputFragment.SUBSCRIBER_ID_KEY, getUserId());
        ...
        if (getActivity() instanceof IPayUtilityBillPayActionActivity) {
            int maxBackStack=1;
            ((IPayUtilityBillPayActionActivity) getActivity()).switchFragment(new AkashBillAmountInputFragment(), bundle, maxBackStack, true);
        }
                    ...
                    try {
                        ...
                        switch (result.getStatus()) {
                            case Constants.HTTP_RESPONSE_STATUS_OK:
                                Bundle bundle = new Bundle();
                                bundle.putString(AkashBillAmountInputFragment.SUBSCRIBER_ID_KEY, getUserId());
                                bundle.putString(AkashBillAmountInputFragment.USER_NAME_KEY, linkThreeSubscriberInfoResponse.getSubscriberName());
                                bundle.putString(AkashBillAmountInputFragment.OTHER_PERSON_NAME_KEY, getOtherPersonName());
                                bundle.putString(AkashBillAmountInputFragment.OTHER_PERSON_MOBILE_KEY, ContactEngine.formatMobileNumberBD(getOtherPersonMobile()) );
