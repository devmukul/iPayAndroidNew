...
public class AmberItBillAmountInputFragment extends IPayAbstractAmountFragment {
	...
	protected void performContinueAction() {
		...
		bundle.putSerializable(AmberItBillConfirmationFragment.BILL_AMOUNT_KEY, getAmount());
