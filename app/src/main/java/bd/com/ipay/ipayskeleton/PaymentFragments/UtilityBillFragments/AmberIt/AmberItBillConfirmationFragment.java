...
import bd.com.ipay.ipayskeleton.PaymentFragments.UtilityBillFragments.LinkThree.LinkThreeBillSuccessFragment;
...
public class AmberItBillConfirmationFragment extends IPayAbstractTransactionConfirmationFragment {
	...
	public void onCreate(@Nullable Bundle savedInstanceState) {
		...
		if (getArguments() != null) {
			subscriberId = getArguments().getString(AmberItBillAmountInputFragment.SUBSCRIBER_ID_KEY, "");
			billAmount = (Number) getArguments().getSerializable(BILL_AMOUNT_KEY);
			userName = getArguments().getString(AmberItBillAmountInputFragment.USER_NAME_KEY, "");
			otherPersonName = getArguments().getString(AmberItBillAmountInputFragment.OTHER_PERSON_NAME_KEY, "");
			otherPersonMobile = getArguments().getString(AmberItBillAmountInputFragment.OTHER_PERSON_MOBILE_KEY, "");
							...
							case Constants.HTTP_RESPONSE_STATUS_OK:
								...
								new Handler().postDelayed(new Runnable() {
									...
									public void run() {
										...
										bundle.putString(AmberItBillAmountInputFragment.SUBSCRIBER_ID_KEY, subscriberId);
										bundle.putString(AmberItBillAmountInputFragment.USER_NAME_KEY, userName);
										bundle.putString(AmberItBillAmountInputFragment.OTHER_PERSON_NAME_KEY, otherPersonName);
                                        bundle.putString(AmberItBillAmountInputFragment.OTHER_PERSON_MOBILE_KEY, otherPersonMobile);
	...
	public void saveRecent(){
        ...
        recentBill.setParamLabel("Subscriber Id");
