...
public class DescoBillSuccessFragment extends IPayBillPayTransactionSuccessFragment implements HttpResponseListener {
    ...
    private void showSaveInfoDialogue(final String subscribeId) {
        ...
        saveBillDialog.setAccountInfo(subscribeId, getString(R.string.account_number));
    ...
    protected void saveAndSchedule(String shortname, boolean isSchedule, String date) {
        ...
        if (linkThreeBillPayTask == null) {
            ...
            billParamList.add(new BillParam(getString(R.string.account_number), "accountNumber", descoAccountId, "String"));
