...
public class CNSSubscriberIdInputFragment extends IPayAbstractUserIdInputFragment implements HttpResponseListener {
    ...
    protected void setupViewProperties() {
        setTitle("Crescent Network Service [CNS]");
        setMerchantIconImage(R.drawable.cns);
    ...
    protected void performContinueAction() {
        ...
        bundle.putString(CNSBillAmountInputFragment.SUBSCRIBER_ID_KEY, getUserId());
        ...
        if (getActivity() instanceof IPayUtilityBillPayActionActivity) {
            int maxBackStack=1;
            ((IPayUtilityBillPayActionActivity) getActivity()).switchFragment(new CNSBillAmountInputFragment(), bundle, maxBackStack, true);
        }
                    ...
                    try {
                        ...
                        switch (result.getStatus()) {
                            case Constants.HTTP_RESPONSE_STATUS_OK:
                                Bundle bundle = new Bundle();
                                bundle.putString(CNSBillAmountInputFragment.SUBSCRIBER_ID_KEY, getUserId());
                                bundle.putString(CNSBillAmountInputFragment.USER_NAME_KEY, linkThreeSubscriberInfoResponse.getSubscriberName());
                                bundle.putString(CNSBillAmountInputFragment.OTHER_PERSON_NAME_KEY, getOtherPersonName());
                                bundle.putString(CNSBillAmountInputFragment.OTHER_PERSON_MOBILE_KEY, ContactEngine.formatMobileNumberBD(getOtherPersonMobile()) );
