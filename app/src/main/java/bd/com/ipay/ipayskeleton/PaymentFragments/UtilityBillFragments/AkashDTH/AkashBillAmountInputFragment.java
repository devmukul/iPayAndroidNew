...
public class AkashBillAmountInputFragment extends IPayAbstractAmountFragment {
	...
	protected void performContinueAction() {
		...
		bundle.putSerializable(AkashBillConfirmationFragment.BILL_AMOUNT_KEY, getAmount());

		if (getActivity() instanceof IPayUtilityBillPayActionActivity) {
			int maxBackStack=2;
			((IPayUtilityBillPayActionActivity) getActivity()).switchFragment(new AkashBillConfirmationFragment(), bundle, maxBackStack, true);
		}
	}
