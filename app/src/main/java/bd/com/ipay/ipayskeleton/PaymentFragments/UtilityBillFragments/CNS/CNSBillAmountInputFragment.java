...
public class CNSBillAmountInputFragment extends IPayAbstractAmountFragment {
	...
	protected void performContinueAction() {
		...
		bundle.putSerializable(CNSBillConfirmationFragment.BILL_AMOUNT_KEY, getAmount());

		if (getActivity() instanceof IPayUtilityBillPayActionActivity) {
			int maxBackStack=2;
			((IPayUtilityBillPayActionActivity) getActivity()).switchFragment(new CNSBillConfirmationFragment(), bundle, maxBackStack, true);
		}
	}
