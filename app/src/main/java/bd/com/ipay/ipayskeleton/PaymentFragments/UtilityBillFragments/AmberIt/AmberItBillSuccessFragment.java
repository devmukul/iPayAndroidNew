...
public class AmberItBillSuccessFragment extends IPayBillPayTransactionSuccessFragment implements HttpResponseListener {
	...
	public void onCreate(@Nullable Bundle savedInstanceState) {
		...
		if (getArguments() != null) {
			billAmount = (Number) getArguments().getSerializable(AmberItBillConfirmationFragment.BILL_AMOUNT_KEY);
	...
	protected void performContinueAction() {
		showSaveInfoDialogue(subscriberId);
	}
	...
	private void showSaveInfoDialogue(final String subscribeId) {
		...
		saveBillDialog.setAccountInfo(subscribeId, getString(R.string.subscriber_id));
	...
	protected void saveAndSchedule(String shortname, boolean isSchedule, String date) {
		...
		if (linkThreeBillPayTask == null) {
            ...
            billParamList.add(new BillParam(getString(R.string.subscriber_id), "subscriberId", subscriberId, "String"));
