...
public class DPDCBillSuccessFragment extends IPayBillPayTransactionSuccessFragment implements HttpResponseListener {
    ...
    protected void performContinueAction() {
        showSaveInfoDialogue(descoAccountId);
    }
    ...
    private void showSaveInfoDialogue(final String subscribeId) {
        ...
        saveBillDialog.setAccountInfo(subscribeId, getString(R.string.customer_number));
    ...
    protected void saveAndSchedule(String shortname, boolean isSchedule, String date) {
        ...
        if (linkThreeBillPayTask == null) {
            ...
            billParamList.add(new BillParam(getString(R.string.customer_number), "customerNumber", descoAccountId, "String"));
            billParamList.add(new BillParam("Amount", "amount", String.valueOf(billAmount), "Number"));
            billParamList.add(new BillParam(getString(R.string.location_code), "locationCode", locationCode, "Number"));
            ...
            savedBill.setProviderCode("DPDC");
