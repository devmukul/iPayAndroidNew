...
public class IpdcScheduledPaymentDetailsFragment extends Fragment {
        ...
        public void onBindViewHolder(@NonNull ScheduledPaymentViewHolder scheduledPaymentViewHolder, int i) {
            ...
            scheduledPaymentViewHolder.parentView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((IPayUtilityBillPayActionActivity) getActivity()).switchFragment(new IpdcScheduledPaymentDetailsFragment(), bundle, 1, true);
                }
            });
        }
